...
local subtitle_home = xdg_data_home .. "/subliminal/"
...
function download_subs(language)
	...
	local video_base_dir = get_base_dir(directory)
	local subtitle_dir = subtitle_home .. video_base_dir
	utils.subprocess({ args = { "mkdir", "-p", subtitle_dir } })
	...
	mp.set_property("sub-file-paths", subtitle_dir)
